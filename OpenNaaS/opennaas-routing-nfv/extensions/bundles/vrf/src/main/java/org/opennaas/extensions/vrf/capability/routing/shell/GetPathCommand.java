...
public class GetPathCommand extends GenericKarafCommand {
    ...
    protected Object doExecute() throws Exception {
        ...
        try {
            ...
            Response response = capab.getRoute(String.valueOf(Utils.StringIPv4toInt(ipSource)), String.valueOf(Utils.StringIPv4toInt(ipDest)), switchip, inputPort, mechanism);
