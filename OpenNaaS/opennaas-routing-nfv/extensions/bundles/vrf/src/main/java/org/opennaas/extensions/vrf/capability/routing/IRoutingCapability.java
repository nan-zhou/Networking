...
public interface IRoutingCapability extends ICapability {
    ...
    @Produces(MediaType.TEXT_PLAIN)
    public Response insertRouteFile(@PathParam("fileName") String fileName, InputStream viDescription) throws CapabilityException;
     ...
     *
     * @param ip-port IP address and port of the controller. (ip:port)
    ...
    @GET
    @Produces(MediaType.TEXT_PLAIN)
    public Response getControllerStatus(@PathParam("ip-port") String ip-port) throws CapabilityException;
